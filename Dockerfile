FROM nextcloud
MAINTAINER Aaron Scheiner <blue@aquarat.co.za>
...
ADD opcache.ini /usr/local/etc/php/conf.d/opcache-recommended.ini
...
# Installs imagick (like Python Pip)
RUN pecl install imagick

RUN        mkdir -p /tmp/workdir
WORKDIR    /tmp/workdir
RUN        apt-get -yqq update
RUN        apt-get install -yq --no-install-recommends ca-certificates expat libgomp1
